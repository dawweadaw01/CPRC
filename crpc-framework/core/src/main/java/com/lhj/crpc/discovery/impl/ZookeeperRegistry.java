package com.lhj.crpc.discovery.impl;

import com.lhj.crpc.Constant;
import com.lhj.crpc.CrpcBootstrap;
import com.lhj.crpc.ServiceConfig;
import com.lhj.crpc.discovery.AbstractRegistry;
import com.lhj.crpc.exceptions.DiscoveryException;
import com.lhj.crpc.utils.NetUtils;
import com.lhj.crpc.utils.ZookeeperNode;
import com.lhj.crpc.utils.ZookeeperUtils;
import com.lhj.crpc.watch.UpAndDownWatcher;
...
public class ZookeeperRegistry extends AbstractRegistry {
    ...
    public void register(ServiceConfig<?> service) {
        ...
        // 192.168.12.121
        //后续处理端口的问题
        String node = parentNode + "/" + NetUtils.getIp() + ":" + CrpcBootstrap.getInstance().getConfiguration().getPort();
